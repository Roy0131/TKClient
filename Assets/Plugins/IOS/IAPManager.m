...
//        NSLog(@"Product currencyCode: %@" , p.priceLocale.currencyCode);
//        NSLog(@"Product calendarIdentifier: %@" , p.priceLocale.currencySymbol);
        
        UnitySendMessage("UIRoot", "OnShopDetailResult", [[self productInfo:p] UTF8String]);
    }
...
-(NSString *)productInfo:(SKProduct *)product{
    NSArray *info = [NSArray arrayWithObjects:product.productIdentifier,product.price,product.priceLocale.currencySymbol,product.priceLocale.currencyCode, nil];
    
    return [info componentsJoinedByString:@"_"];
}
...
-(void) provideContent:(SKPaymentTransaction *)transaction{
    UnitySendMessage("UIRoot", "ProvideContent", [[self transactionInfo:transaction] UTF8String]);
}
...
-(void) failedTransaction:(SKPaymentTransaction *)transaction{
    ...
    UnitySendMessage("UIRoot", "AppStoreBuyFailed", "");
    [[SKPaymentQueue defaultQueue] finishTransaction:transaction];
}
