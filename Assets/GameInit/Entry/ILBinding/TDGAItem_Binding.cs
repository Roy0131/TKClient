...
namespace ILRuntime.Runtime.Generated
{
    unsafe class TDGAItem_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, OnPurchase_0);


        }


        static StackObject* OnPurchase_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
