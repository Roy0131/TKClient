...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Google_Protobuf_MessageParser_1_Adapt_IMessage_Binding_Adaptor_Binding
    {
        ...
        static StackObject* ParseFrom_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Google.Protobuf.ByteString @data = (Google.Protobuf.ByteString)typeof(Google.Protobuf.ByteString).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
