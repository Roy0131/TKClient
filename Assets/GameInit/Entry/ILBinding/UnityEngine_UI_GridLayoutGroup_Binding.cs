...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_GridLayoutGroup_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_cellSize_0);
            args = new Type[]{typeof(UnityEngine.Vector2)};
        ...
        static StackObject* set_cellSize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
