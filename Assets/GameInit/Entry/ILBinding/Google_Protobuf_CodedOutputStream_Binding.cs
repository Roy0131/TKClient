...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Google_Protobuf_CodedOutputStream_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("WriteRawTag", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, WriteRawTag_4);
            ...
            app.RegisterCLRMethodRedirection(method, WriteBytes_7);
            args = new Type[]{typeof(Google.Protobuf.ByteString)};
            method = type.GetMethod("ComputeBytesSize", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ComputeBytesSize_8);
        ...
        static StackObject* WriteRawTag_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* WriteBytes_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* ComputeBytesSize_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
