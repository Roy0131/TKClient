...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Google_Protobuf_MessageExtensions_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, ToByteString_0);
            args = new Type[]{typeof(Google.Protobuf.IMessage)};
        ...
        static StackObject* ToByteString_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Google.Protobuf.MessageExtensions.ToByteString(@message);
